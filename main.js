        ...
        unsubscribeBudget = onSnapshot(budgetDocRef, (docSnap) => {
            try {
                ...
                if (docSnap.exists()) {
                    ...
                    showNotification(`Error: Could not find budget with ID ${budgetId}. Reloading...`, "danger");
                    initializeAppState();
...
async function deleteCurrentBudget() {
    ...
    if (confirmed) {
        ...
        const idToDelete = activeBudgetId;
        
        delete allBudgets[idToDelete];
        ...
        try {
            ...
            allBudgets[idToDelete] = budgetNameToDelete;
        }
    }
}
