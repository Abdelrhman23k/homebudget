...
onAuthStateChanged(auth, async (user) => {
    if (user) {
        ...
        initializeEventListeners(); // MOVED HERE
...
// ... (The rest of the many functions follow, exactly as they were in the previous complete file)
// This is a placeholder for brevity.
// In a real scenario, all functions would be pasted here.
